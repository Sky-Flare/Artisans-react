...
export type AllFilmsTestQueryVariables = Exact<{ [key: string]: never; }>;


export type AllFilmsTestQuery = { __typename?: 'Root', allFilms?: { __typename?: 'FilmsConnection', edges?: Array<{ __typename?: 'FilmsEdge', node?: { __typename?: 'Film', title?: string | null } | null } | null> | null } | null };


export const AllFilmsTestDocument = gql`
    query AllFilmsTest {
  allFilms {
    edges {
      node {
...
/**
 * __useAllFilmsTestQuery__
 *
 * To run a query within a React component, call `useAllFilmsTestQuery` and pass it any options that fit your needs.
 * When your component renders, `useAllFilmsTestQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAllFilmsTestQuery({
 *   variables: {
 *   },
 * });
 */
export function useAllFilmsTestQuery(baseOptions?: Apollo.QueryHookOptions<AllFilmsTestQuery, AllFilmsTestQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AllFilmsTestQuery, AllFilmsTestQueryVariables>(AllFilmsTestDocument, options);
      }
export function useAllFilmsTestLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AllFilmsTestQuery, AllFilmsTestQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AllFilmsTestQuery, AllFilmsTestQueryVariables>(AllFilmsTestDocument, options);
        }
export function useAllFilmsTestSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<AllFilmsTestQuery, AllFilmsTestQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<AllFilmsTestQuery, AllFilmsTestQueryVariables>(AllFilmsTestDocument, options);
        }
export type AllFilmsTestQueryHookResult = ReturnType<typeof useAllFilmsTestQuery>;
export type AllFilmsTestLazyQueryHookResult = ReturnType<typeof useAllFilmsTestLazyQuery>;
export type AllFilmsTestSuspenseQueryHookResult = ReturnType<typeof useAllFilmsTestSuspenseQuery>;
export type AllFilmsTestQueryResult = Apollo.QueryResult<AllFilmsTestQuery, AllFilmsTestQueryVariables>;